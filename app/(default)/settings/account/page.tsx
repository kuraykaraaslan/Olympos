  ...
  return (
    <>
      <div className="">
        ...
        <p className="font- text-slate-600">Manage your account settings here</p>
      </div>
      <hr className="mt-4 mb-8" />
      <p className="py-2 text-xl font-semibold">Email Address</p>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <p className="text-gray-600">Your email address is <strong>kuraykaraaslan@gmail.com</strong></p>
      ...
      <p className="mt-2">Can not remember your current password. <a className="text-sm font-semibold text-blue-600 underline decoration-2" href="#">Recover Account</a></p>
